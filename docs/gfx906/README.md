...
see the prompt-format note below), and **Muse-Glimmer stays
pinned to V1** (`VLLM_USE_V2_MODEL_RUNNER=0`, the model whose parity run has
...
| `VLLM_USE_V2_MODEL_RUNNER` | (upstream) | `0` forces the V1 runner — still required for **Muse-Glimmer** (Gemma-4 was V2-validated 2026-09-15; V1 removed upstream in 0.32.0) |
