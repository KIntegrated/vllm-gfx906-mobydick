...
| Qwen3.8-27B-AWQ-INT4 (dense) | fully functional (TP=1 + TP=2) | **28.6** (TP=1, 4k ctx) / **32.8** @131k TP=2 |
...
| ↳ TP=2 (2× MI50) | 445k-token KV pool; **256k context validated** (FA gather fix, 2026-08-24) | **28.8** @4k / **32.8** @131k ctx |
